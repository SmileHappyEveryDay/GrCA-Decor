...
result_dir_ = '/home/hk/MARL-Algorithms-just-counterfact-icassp/result' if hostname != "DESKTOP-ANP1MI8" else r"C:\Users\Weiqiang Jin\Downloads\MARL-Algorithms-just-counterfact-icassp\result"
...
def get_common_args():
    ...
    parser.add_argument('--result_dir', type=str, default=result_dir_, help='result directory of the policy') # MARLalgorithm-icassp-only
    parser.add_argument('--load_model', type=bool, default=False, help='whether to load the pretrained model')
    parser.add_argument('--evaluate', type=bool, default=False, help='whether to evaluate the model')
    parser.add_argument('--cuda', type=bool, default=True, help='whether to use the GPU') # --cuda=False
    parser.add_argument('--total_test_number', type=int, default=3, help='how iter to test the model') # 7
    parser.add_argument('--flag_use_counterfact_adv', type=bool, default=True, help='whether to use counterfact advantage.')
